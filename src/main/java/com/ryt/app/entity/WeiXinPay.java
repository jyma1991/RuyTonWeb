...
public class WeiXinPay implements Serializable {
	...
	private String err_code_des;//错误代码描述，非必须
	private String openid;//用户标识
	private String is_subscribe;//是否关注公众账号，非必须
	private String trade_type;//交易类型
	private String bank_type;//付款银行
	private Integer total_fee;//总金额
	private String fee_type;//货币种类,非必须
	private Integer cash_fee;//现金支付金额
	private String cash_fee_type;//现金支付货币类型,非必须
	private Integer coupon_fee;//代金券或立减优惠金额
	private Integer coupon_count;//代金券或立减优惠使用数量,非必须
	private String coupon_id_$n;//代金券或立减优惠ID，非必须
	private Integer coupon_fee_$n;//单个代金券或立减优惠支付金额
	private String transaction_id;//微信支付订单号
	private String out_trade_no;//商户订单号	
	private String attach;//商家数据包，非必须
