...
//	
//	//缩略图的文件路径
//	public UploadUtil(String relativePath,String absolutePath){
...
//
//		// 
//		relativePath = relativePath + "/scalezoom/" + fileNewName;
//		absolutePath = absolutePath+"/scalezoom/"+fileNewName;
//		File relatvieDir = new File(relativePath);
//		/*if(relatvieDir.)*/
