...
public class AuthDataPermissionSch extends SearchEasyUI{
    ...
    private String dataColumnSch;
    private String equalSch;
    private String dataValueSch;
    ...
    @ValueField(column = "expressionType")
    public Byte getExpressionTypeSch(){
        return this.expressionTypeSch;
    }

    public void setDataColumnSch(String dataColumnSch){
        this.dataColumnSch = dataColumnSch;
    }
    
    @ValueField(column = "dataColumn")
    public String getDataColumnSch(){
        return this.dataColumnSch;
    }
    ...
    public void setDataValueSch(String dataValueSch){
        this.dataValueSch = dataValueSch;
    }
    
    @ValueField(column = "dataValue")
    public String getDataValueSch(){
        return this.dataValueSch;
    }
