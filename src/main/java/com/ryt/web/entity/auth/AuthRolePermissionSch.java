...
public class AuthRolePermissionSch extends SearchEasyUI{
    ...
    @ValueField(column = "roleId")
    public Integer getRoleIdSch(){
        return this.roleIdSch;
    }

    public void setSysFuncIdSch(Integer sysFuncIdSch){
        this.sysFuncIdSch = sysFuncIdSch;
    }
    
    @ValueField(column = "sysFuncId")
    public Integer getSysFuncIdSch(){
        return this.sysFuncIdSch;
    }
