...
public class FinanceChargeProductSch extends SearchEasyUI{
    ...
    private String picIdsSch;
    private Integer productTypeSch;
    private String remarkSch;
    private BigDecimal originalPriceSch;
    private BigDecimal presentPriceSch;
    ...
    public void setPicIdsSch(String picIdsSch){
        this.picIdsSch = picIdsSch;
    }
    
    @ValueField(column = "picIds")
    public String getPicIdsSch(){
        return this.picIdsSch;
    }

    public void setProductTypeSch(Integer productTypeSch){
        this.productTypeSch = productTypeSch;
    }
    
    @ValueField(column = "productType")
    public Integer getProductTypeSch(){
        return this.productTypeSch;
    }
    ...
    public void setOriginalPriceSch(BigDecimal originalPriceSch){
        this.originalPriceSch = originalPriceSch;
    }
    
    @ValueField(column = "originalPrice")
    public BigDecimal getOriginalPriceSch(){
        return this.originalPriceSch;
    }

    public void setPresentPriceSch(BigDecimal presentPriceSch){
        this.presentPriceSch = presentPriceSch;
    }
    
    @ValueField(column = "presentPrice")
    public BigDecimal getPresentPriceSch(){
        return this.presentPriceSch;
    }
