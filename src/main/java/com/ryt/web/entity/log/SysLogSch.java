...
public class SysLogSch extends SearchEasyUI{
    ...
    private String requestURLSch;
    private String queryStringSch;
    private String remoteAddrSch;
    ...
    public void setRequestURLSch(String requestURLSch){
        this.requestURLSch = requestURLSch;
    }
    
    @ValueField(column = "requestURL")
    public String getRequestURLSch(){
        return this.requestURLSch;
    }

    public void setQueryStringSch(String queryStringSch){
        this.queryStringSch = queryStringSch;
    }
    
    @ValueField(column = "queryString")
    public String getQueryStringSch(){
        return this.queryStringSch;
    }

    public void setRemoteAddrSch(String remoteAddrSch){
        this.remoteAddrSch = remoteAddrSch;
    }
    
    @ValueField(column = "remoteAddr")
    public String getRemoteAddrSch(){
        return this.remoteAddrSch;
    }
