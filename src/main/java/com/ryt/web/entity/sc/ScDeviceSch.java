...
public class ScDeviceSch extends SearchEasyUI{
    ...
    private Integer deviceTypeIdSch;
    private Integer agentIdSch;
    private String remarkSch;
    private Integer isValidSch;
    ...
    @ValueField(column = "deviceName")
    public String getDeviceNameSch(){
        return this.deviceNameSch;
    }

    public void setDeviceTypeIdSch(Integer deviceTypeIdSch){
        this.deviceTypeIdSch = deviceTypeIdSch;
    }
    
    @ValueField(column = "deviceTypeId")
    public Integer getDeviceTypeIdSch(){
        return this.deviceTypeIdSch;
    }
    ...
    public void setIsValidSch(Integer isValidSch){
        this.isValidSch = isValidSch;
    }
    
    @ValueField(column = "isValid")
    public Integer getIsValidSch(){
        return this.isValidSch;
    }
