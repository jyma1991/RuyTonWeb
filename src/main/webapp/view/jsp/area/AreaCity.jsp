                        ...
                        <table class="table">
                            <tbody>
                                    ...
                                    <td><input id="id" readonly="readonly" name="id" class="textbox"      style="height: 22px;" /></td>
                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>cityName:</th>
                                    <td><input id="cityName" name="cityName" class="textbox"      style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>provinceId:</th>
                                    <td><input id="provinceId" value="0" name="provinceId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>districtId:</th>
                                    <td><input id="districtId" value="0" name="districtId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                <th>操作</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listAreaCity.do',
                    columns:[[
            		            			{field:'id',title:'id'}
            		            			,{field:'cityName',title:'cityName'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateAreaCity.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getAreaCityById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addAreaCity.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
