                    ...
                    <fieldset>
                        ...
                        <table class="table">
                            <tbody>
                                                                                                                                                                                                                                                                <tr>
                                    <th>cellName</th>
                                    <td><input id="cellName" name="cellName" class="textbox"      style="height: 22px;" /></td>
                                </tr>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             <tr>
                                    <th>sysClassId</th>
                                    <td><input id="sysClassId" value="0" name="sysClassId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        <tr>
                                    <th>articleBaseId</th>
                                    <td><input id="articleBaseId" value="0" name="articleBaseId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                <tr>
                                    <th>id</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listArticleExtend.do',
                    columns:[[
            		            			{field:'cellName',title:'cellName'}
            		            			,{field:'cellValue',title:'cellValue'}
            		            			,{field:'sysClassId',title:'sysClassId'}
            		            			,{field:'articleBaseId',title:'articleBaseId'}
            		            			,{field:'id',title:'id'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateArticleExtend.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getArticleExtendById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addArticleExtend.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
