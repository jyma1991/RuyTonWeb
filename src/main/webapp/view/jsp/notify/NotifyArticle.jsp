                    ...
                    <fieldset>
                        ...
                        <table class="table">
                            <tbody>
                                                                                                                                                                                                <tr>
                                    <th>parentId</th>
                                    <td><input id="parentId" value="0" name="parentId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>senderId</th>
                                    <td><input id="senderId" value="0" name="senderId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>schooldId</th>
                                    <td><input id="schooldId" value="0" name="schooldId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>classId</th>
                                    <td><input id="classId" value="0" name="classId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>articleId</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listNotifyArticle.do',
                    columns:[[
            		            			{field:'parentId',title:'parentId'}
            		            			,{field:'senderId',title:'senderId'}
            		            			,{field:'schooldId',title:'schooldId'}
            		            			,{field:'classId',title:'classId'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateNotifyArticle.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getNotifyArticleById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addNotifyArticle.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
