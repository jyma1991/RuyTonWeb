                        ...
                        <table class="table">
                            <tbody>
                                    ...
                                    <td><input id="classId" value="0" name="classId" class="textbox"   style="height: 22px;" /></td>
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>teacherId</th>
                                    <td><input id="teacherId" value="0" name="teacherId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>isManager</th>
                                    <td><input id="isManager" value="0" name="isManager" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>id</th>
                                    <td><input id="id" value="0" name="id" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>userId</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listScClassTeacher.do',
                    columns:[[
            		            			{field:'classId',title:'classId'}
            		            			,{field:'teacherId',title:'teacherId'}
            		            			,{field:'isManager',title:'isManager'}
            		            			,{field:'id',title:'id'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateScClassTeacher.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getScClassTeacherById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addScClassTeacher.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
