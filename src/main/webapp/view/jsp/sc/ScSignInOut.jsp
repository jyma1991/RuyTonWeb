                    ...
                    <fieldset>
                        ...
                        <table class="table">
                            <tbody>
                                                                                                                                                                                                                                                                <tr>
                                    <th>studentId</th>
                                    <td><input id="studentId" name="studentId" class="textbox"      style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>picId</th>
                                    <td><input id="picId" value="0" name="picId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>signInTime</th>
                                    <td><input id="signInTime" name="signInTime" data-options="disabled:true" class="easyui-datetimebox"  style="width: 180px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>signOutTime</th>
                                    <td><input id="signOutTime" name="signOutTime" data-options="disabled:true" class="easyui-datetimebox"  style="width: 180px;" /></td>
                                </tr>
                                                                                                                                                                <tr>
                                    <th>id</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listScSignInOut.do',
                    columns:[[
            		            			{field:'studentId',title:'studentId'}
            		            			,{field:'picId',title:'picId'}
            		            			,{field:'signInTime',title:'signInTime'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateScSignInOut.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getScSignInOutById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addScSignInOut.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
