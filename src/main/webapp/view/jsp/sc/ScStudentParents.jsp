<%@ page language="java" contentType="text/html; charset=utf-8"
    ...
    <body>
                            ...
                            <tbody>
                               <input id="studentId" value="<%=request.getParameter("studentId")%>" name="studentId" class="textbox" style="height: 22px; display:none;"  />
                                ...
                                <tr>
                                    <th>视频有效期</th>
                                    <td>
                                        <input name="vipEndDate" class="easyui-datebox" style="width: 200px" />
                                    </td>
                                </tr>
                                  <tr>
                                    <th>详细地址</th>
                                ...
                                <tr id="userNameTr">
                                    <th>电话</th>
                                    <td>
                                       <input id="mobilePhone" name="user.mobilePhone"  data-options="validType:'mobile'"  class="textbox easyui-validatebox" style="height: 22px;" /> 
                                    </td>
                                </tr>
                                <tr id = "idpwd">
                                      <th>密码</th>
        ...
        function copyDefaulValue()
        {
           ...
           /* document.getElementById('userName').adattr(); */
        ...
        $("#back").click(function() {
        	...
        	if( $("#id").val().trim().length>0 ){
				window.location.href="ScStudent.jsp?studentId="+studentId+"&classId="+classId;
			}else{
				$.messager.show({
					title : message.title.normal,
