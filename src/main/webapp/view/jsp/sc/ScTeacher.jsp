...
<%@page import="org.durcframework.core.UserContext" %>
        ...
        <body>
                                ...
                                <tbody>
                                    <tr id = "idTr">
                                        ...
                                        <td>
                                            ...
                                            <input id="schoolId"  name="schoolId" value="<%=UserContext.getInstance().getUser().getId()%>" class="textbox" style="height: 22px;" />
                                        </td>
                                    </tr>
                                 <tr>
									<th>选择班级</th>
            ...
            var userId = <%=UserContext.getInstance().getUser().getId()%>;
                var globalClassId;
                var globalTeacherId;
                var comboxTexts;
                var nowrow;
                ...
                $(function () {
                    ...
                    grid = $('#grid').datagrid({
                            ...
                            singleSelect: true,
                            rownumbers: true,
                            url: ctx + 'getScTeacherByTrueName.do?schoolIdSch='+userId,
                            columns: [[{
                                    field: 'id',
                                    title: 'id',
                                    hidden: 'true',
                    ...
                    $("#operateMode_submit")
                     ...
                     $("#btn_import").click(function() {
                        var btn = $(this);
                        url = '../../pluploader.jsp?moduleId=sc&funcId=importTeacher'+'&userId=' + userId;
