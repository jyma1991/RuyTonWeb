...
<%@page import="org.durcframework.core.UserContext"%>
    ...
    <body>
                ...
                <form id="searchForm">
                    <table>
                        ...
                        <tr>
                            <td>学校</td>
                            <td>
                                <input id="schoolIdSch" name="schoolIdSch" class="textbox" editable="false" style="width: 120px; height: 22px;" />
                            </td>
                            <td>场所类型</td>
                            <td>
		...
		if(roleName == "school"){
      	...
      	//初始化代理商
        $.getJSON(ctx+'listAllScSchool.do'+param,function(schoolJson){
        ...
        //当前登录人的ID 该页面应该是园长 即schoolId
            $(function() {
                ...
                grid = $('#grid').datagrid({
                    ...
                    singleSelect: true,
                    rownumbers: true,
                    url: ctx + 'listStatisticScClass.do'+param,
                    columns: [
                        [{
                            field: 'id',
                            title: 'ID',
