                        ...
                        <table class="table">
                            <tbody>
                                    ...
                                    <td><input id="id" value="0" name="id" class="textbox"   style="height: 22px;" /></td>
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>streamId:</th>
                                    <td><input id="streamId" value="0" name="streamId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>userId:</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listStStreamUser.do',
                    columns:[[
            		            			{field:'id',title:'id'}
            		            			,{field:'streamId',title:'streamId'}
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateStStreamUser.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getStStreamUserById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addStStreamUser.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
