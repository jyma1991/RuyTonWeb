            ...
            <div data-options="region:'north',split:true,border:false" style="height:80px;">
                <form id="searchForm">
                    ...
                    <table>
                        <tr>
                            <td>版本号</td>
                            <td><input name="versionIdSch" class="textbox" style="width: 120px; height: 22px;" /></td>
                            <td>创建时间</td>
                    ...
                    <fieldset>
                        ...
                        <table class="table">
                            <tbody>
                                                                                                                                                                                                                            <tr>
                                    <th>ID</th>
                                    <td><input id="id" readonly="readonly" name="id" class="textbox"      style="height: 22px;width:60px;background:#eee;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                <tr>
                                    <th>版本名称</th>
                                    <td><input id="versionName" name="versionName" class="textbox easyui-validatebox" required="true"      style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>版本号</th>
                                    <td><input id="versionId" name="versionId" class="textbox easyui-validatebox" required="true"      style="height: 22px;width:100px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>版本内容</th>
                                    <td>
                                    	<textarea cols="100" id="content" name="content" class="textbox"   style="width:400px;height: 50px;line-height:22px;" ></textarea>                        
                                    </td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>下载地址</th>
                                    <td><input id="loadUrl" name="loadUrl" class="textbox easyui-validatebox" required="true"      style="height: 22px;width:400px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>强制更新</th>
                                    <td>
                                    	
                                    	<input  name="must"  type="radio" value="1"    style="height: 22px;float:left;"/><span style="line-height:28px;display:block; float:left;" >是</span>
                                    	<input  name="must"  type="radio" value="0"   style="height: 22px;float:left;" checked /><span style="line-height:28px;display:block; float:left;" >否</span>
                                    </td>
                                </tr>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listSysVersion.do',
                    columns:[[				{field:'id',title:'ID',sortable:true}
                    						,{field:'versionId',title:'版本号',sortable:true}
            		            			,{field:'versionName',title:'版本名称',sortable:true}
            		            			//,{field:'content',title:'版本内容',sortable:true}
            		            			,{field:'loadUrl',title:'下载地址',sortable:true}
            		            			,{
            		            				field:'must',
            		            				title:'强制更新',
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateSysVersion.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getSysVersionById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addSysVersion.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
