                        ...
                        <table class="table">
                            <tbody>
                                    ...
                                    <td><input id="userId" value="0" name="userId" class="textbox"   style="height: 22px;" /></td>
                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>versionId</th>
                                    <td><input id="versionId" value="0" name="versionId" class="textbox"   style="height: 22px;" /></td>
                                </tr>
                                                                                                                                                                                                                                                                                                                                                                                                <tr>
                                    <th>id</th>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                grid=$('#grid').datagrid({
                    ...
                    singleSelect : true,
                    rownumbers : true,
                    url:ctx+'listUserVersion.do',
                    columns:[[
            		            			{field:'createTime',title:'createTime'}
            		            			,{field:'userId',title:'userId'}
            		            			,{field:'versionId',title:'versionId'}
            		            			,{field:'id',title:'id'}
            		                    ]],
                ...
                $("#operateMode_submit").click(function() {
                    ...
                    if ($('#form').form('validate')) {
                        if (idValue > 0) {
                            //修改
                            $.post(ctx+"updateUserVersion.do", fw.serializeObject($('form')), function(result) {
                                if (result.success) {
                                    $.messager.show({
                                        title : message.title.normal,
                                    ...
                                    //重新获取form信息内容
                                    $("#form").form("load", ctx+"getUserVersionById.do?id=" + idValue);
                                }
                            }, 'json');
                        } else {
                            if(idValue.trim().length == 0){
                                ...
                                //添加
                                $.post(ctx+"addUserVersion.do", fw.serializeObject($('form')), function(result) {
                                    if (result.success) {
                                        $.messager.show({
                                            title : message.title.normal,
